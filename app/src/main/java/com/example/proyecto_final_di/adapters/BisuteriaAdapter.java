...
public class BisuteriaAdapter extends RecyclerView.Adapter<BisuteriaAdapter.ViewHolder> {

    private List<ItemGeneral> datosBisuteria;
    ...
    public BisuteriaAdapter(List<ItemGeneral> datosBisuteria) {
        this.datosBisuteria = datosBisuteria;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final  int position) {
        ...
        ItemGeneral item = datosBisuteria.get(position);
        ...
        viewHolder.getImg().setImageResource(datosBisuteria.get(position).getImg());
        viewHolder.getNombreTextView().setText(datosBisuteria.get(position).getNombre());
        viewHolder.getPrecioTextView().setText(String.valueOf(datosBisuteria.get(position).getPrecio()));


        ItemGeneral item2 = datosBisuteria.get(position);
